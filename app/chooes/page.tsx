    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center p-4">
      ...
      <div className="bg-green-400 w-full flex items-center justify-between p-4 px-6 border border-black">
        <div className="flex items-center space-x-4">
          ...
          <Image src={houseclean} 
          alt="houseclean" 
          width={50} 
          height={50} className="rounded-full border border-black"/>
     ...
     <div className="flex items-center space-x-4">
       ...
       {/*} <div className="bg-pink-100 p-10 rounded-lg mt-5 border border-black"></div>
        <div className="bg-pink-100 p-10 rounded-lg mt-2 border border-black"></div>
        
      </div>

      {/* Button */}
      
      <button className="bg-gray-300 text-black py-2 px-6 rounded-lg border border-black">ຖັດໄປ</button>
    </div>
